...
//消除Visual Studio的实现警告
#ifdef _MSC_VER
#define _SILENCE_TR1_NAMESPACE_DEPRECATION_WARNING
#define _SILENCE_ALL_CXX17_DEPRECATION_WARNINGS
#pragma warning(disable: 5053 4455 4996 4984 4083 4081 4002)
#endif
...
namespace ext {
    void verify(const bool expr = false, const std::string message = "") {
        if (expr) return;
        if (!message.empty()) std::cerr << message << std::endl;
        else std::cerr << "Assertion failed." << std::endl;
        std::terminate();
    }
    class acc {
    private:
        ...
        void constructFromFraction(
            ...
            maxtype(*fp)(T) = &acc::roundUpOrDown<T>//无限小数或明确降低数据精度时的处理方法
        ) {
    ...
    public:
        ...
        // 幂运算函数
        static acc pow(const acc& base, int exponent) {
            if (exponent == 0) return 1;
            if (exponent < 0) {
                // 简单处理：返回1除以幂
                return 1.0 / std::pow((long double)base, -exponent);
            }
        ...
        // 加法运算符
        acc operator+(int other)const {
            return *this + (acc)other;
        }
        acc operator+(long double other)const {
            return *this + (acc)other;
        }
        ...
        acc operator/(maxtype other)const {
            return *this / (acc)other;
        }
...
#pragma endregion
    ...
    // 函数指针类型定义
    using single_func_ld = long double(*)(long double);
    using double_func_ld = long double(*)(long double, long double);

    // 获取标准库函数的 long double 版本
    template<single_func_ld func>
    inline single_func_ld get_single_func() {
        return func;
    }

    template<double_func_ld func>
    inline double_func_ld get_double_func() {
        return func;
    }

    // 应用函数（单参数）
    inline acc apply_single(acc x, single_func_ld f) {
        return acc(f(static_cast<long double>(x)));
    }

    // 应用函数（双参数）
    inline acc apply_double(acc x, acc y, double_func_ld f) {
        return acc(f(static_cast<long double>(x),
    ...
    // 取整函数
    inline acc floor(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::floor);
        return apply_single(x, f);
    }

    inline acc ceil(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::ceil);
        return apply_single(x, f);
    }

    inline acc trunc(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::trunc);
        return apply_single(x, f);
    }

    inline acc round(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::round);
        return apply_single(x, f);
    }

    // 平方根和立方根
    inline acc sqrt(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::sqrt);
        return apply_single(x, f);
    }

    inline acc cbrt(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::cbrt);
        return apply_single(x, f);
    }

    // 三角函数
    inline acc sin(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::sin);
        return apply_single(x, f);
    }

    inline acc cos(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::cos);
        return apply_single(x, f);
    }

    inline acc tan(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::tan);
        return apply_single(x, f);
    }

    inline acc asin(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::asin);
        return apply_single(x, f);
    }

    inline acc acos(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::acos);
        return apply_single(x, f);
    }

    inline acc atan(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::atan);
        return apply_single(x, f);
    }

    // 双曲函数
    inline acc sinh(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::sinh);
        return apply_single(x, f);
    }

    inline acc cosh(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::cosh);
        return apply_single(x, f);
    }

    inline acc tanh(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::tanh);
        return apply_single(x, f);
    }

    // 指数和对数函数
    inline acc exp(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::exp);
        return apply_single(x, f);
    }

    inline acc exp2(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::exp2);
        return apply_single(x, f);
    }

    inline acc log(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::log);
        return apply_single(x, f);
    }

    inline acc log10(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::log10);
        return apply_single(x, f);
    }

    inline acc log2(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::log2);
        return apply_single(x, f);
    }

    // 其他函数
    inline acc erf(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::erf);
        return apply_single(x, f);
    }

    inline acc erfc(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::erfc);
        return apply_single(x, f);
    }

    inline acc tgamma(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::tgamma);
        return apply_single(x, f);
    }

    inline acc lgamma(acc x) {
        static const single_func_ld f =
            static_cast<single_func_ld>(std::lgamma);
        return apply_single(x, f);
    }

    // ============== 双参数数学函数 ==============

    inline acc pow(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::pow);
        return apply_double(x, y, f);
    }

    inline acc fmod(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::fmod);
        return apply_double(x, y, f);
    }

    inline acc remainder(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::remainder);
        return apply_double(x, y, f);
    }

    inline acc atan2(acc y, acc x) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::atan2);
        return apply_double(y, x, f);
    }

    inline acc hypot(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::hypot);
        return apply_double(x, y, f);
    }

    inline acc copysign(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::copysign);
        return apply_double(x, y, f);
    }

    inline acc fdim(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::fdim);
        return apply_double(x, y, f);
    }

    inline acc fmax(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::fmax);
        return apply_double(x, y, f);
    }

    inline acc fmin(acc x, acc y) {
        static const double_func_ld f =
            static_cast<double_func_ld>(std::fmin);
        return apply_double(x, y, f);
    }
    ...
    // frexp: 分解为尾数和指数
    inline acc frexp(acc x, int* exp) {
        long double ld_x = static_cast<long double>(x);
        long double result = std::frexp(ld_x, exp);
        return acc(result);
    }

    // modf: 分解为整数和小数部分
    inline acc modf(acc x, acc* intpart) {
        long double ld_x = static_cast<long double>(x);
        long double ld_intpart;
        long double result = std::modf(ld_x, &ld_intpart);
        *intpart = acc(ld_intpart);
        return acc(result);
    }

    // ldexp: x * 2^exp
    inline acc ldexp(acc x, int exp) {
        long double result = std::ldexp(static_cast<long double>(x), exp);
        return acc(result);
    }

    // scalbn: x * FLT_RADIX^exp
    inline acc scalbn(acc x, int exp) {
        long double result = std::scalbn(static_cast<long double>(x), exp);
        return acc(result);
    }

    // nextafter: 下一个可表示值
    inline acc nextafter(acc x, acc y) {
        long double result = std::nextafter(
...
// 在 acc 类定义之后，main 函数之前添加
namespace std {
    template<>
    class numeric_limits<ext::acc> {
    public:
        // 基本特性
        ...
        // 精度相关
        static constexpr int digits = 0;           // 可变精度
        static constexpr int digits10 = 0;         // 可变精度
        static constexpr int max_digits10 = 34;    // 类似 decimal128

        // 指数范围（使用十进制）
        static constexpr int radix = 10;
        static constexpr int min_exponent = -6143;
        static constexpr int min_exponent10 = -6143;
        static constexpr int max_exponent = 6144;
        static constexpr int max_exponent10 = 6144;

        // 极值函数
        static ext::acc min() noexcept {
            return ext::acc("1E-6143");
        }

        static ext::acc max() noexcept {
            return ext::acc("9.999999999999999999999999999999999E+6144");
        }

        static ext::acc lowest() noexcept {
            return -max();
        }

        static ext::acc epsilon() noexcept {
            return ext::acc("1E-34");
        }

        static ext::acc round_error() noexcept {
            return ext::acc("0.5");
        }

        static ext::acc infinity() noexcept {
            return ext::acc(0);
        }

        static ext::acc quiet_NaN() noexcept {
            return ext::acc(0);
        }

        static ext::acc signaling_NaN() noexcept {
            return ext::acc(0);
        }

        static ext::acc denorm_min() noexcept {
            return ext::acc(0);
        }
...
namespace std {
    // 特化类型特征
    template<>
    struct is_arithmetic<ext::acc> : true_type {};

    template<>
    struct is_floating_point<ext::acc> : true_type {};

    template<>
    struct is_compound<ext::acc> : true_type {};

    // 为 common_type 添加特化，支持混合运算
    template<typename T>
    struct common_type<T, ext::acc> {
        // 如果 T 也是算术类型，提升到 acc
        using type = std::conditional_t<
            std::is_arithmetic_v<T>,
            ext::acc,
            typename common_type<T, ext::acc>::type  // 递归或报错
        >;
    };

    template<typename T>
    struct common_type<ext::acc, T> : common_type<T, ext::acc> {};

    template<>
    struct common_type<ext::acc, ext::acc> {
        using type = ext::acc;
    };
...
//    std::cout << "pow(3, 4) = " << std::pow<acc, acc>(a, b) << " (预期: 81)\n";
    std::cout << "sqrt(4) = " << sqrt(a) << " (预期: 2)\n";
    //std::cout << "abs(-3.5) = " << abs(T(-3.5)) << " (预期: 3.5)\n";
    std::cout << "floor(2.7) = " << floor(a) << " (预期: 2)\n";
    std::cout << "ceil(2.1) = " << ceil(a) << " (预期: 3)\n";
    std::cout << "fmod(5.5, 2.0) = " << fmod(a, b) << " (预期: 1.5)\n\n";
    cout << sin(a) << endl;
    // 2. 数值算法测试（可能使用epsilon, max等）
    std::cout << "2. 算法库测试:\n";
    std::vector<T> vec = { T(3.0), T(1.0), T(4.0), T(1.0), T(5.0) };

    // min/max_element 可能不依赖numeric_limits
...
int prevMain() {
    cout << -16 % (3) << endl;
    cout << ((acc)-16 % (acc)3) << endl;
    acc g = .6;
    acc val(3.0), div(2.0);
    std::cout << val / div << std::endl;
    cout << (typeid(g) == typeid(int)) << endl;
    cout << "Maximum value between val and div:" << max(val, div) << endl;
